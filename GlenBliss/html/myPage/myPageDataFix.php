            ...
            <div class='contents'>
                ...
                <table class="myDataArea">
                    <tr>
                        ...
                        <td class="rightBoxes"><input class='text' type='text' name='user_nickName' value='<?=$memberData['MEM_NICKNAME']?>' required></td>
                    </tr>
                    <tr>
...
END;
                    ...
                    <tr>
                        ...
                        <td class="rightBoxes"><input class='text' type='text' name='user_hp' value='<?=$memberData['MEM_PHONE']?>' required></td>
                    </tr>
                    <tr>
                        <td class="leftTitles"><p class="leftTitle">이메일 주소</p></td>
                        <td class="rightBoxes"><input class='text' type='email' name='user_email' value='<?=$memberData['MEM_EMAIL']?>' required></td>
                    </tr>
                    <tr>
                        <td class="leftTitles"><p class="leftTitle">주소</p></td>
                        <td class="rightBoxes"><input class='text' type='text' name='user_addr' value='<?=$memberData['MEM_ADDRESS']?>' required></td>
                    </tr>
                </table>   
