...
//인스타그램 팝업
function instagramPopupFind() {
	var instargramPopUp = document.getElementById("instargramPopUp");
	var popUpBackground = document.getElementById("popUpBackground");

	instargramPopUp.style.display = "block";
	popUpBackground.style.display = "block";
}
function exitEventResultPopUp() {
	var instargramPopUp = document.getElementById("instargramPopUp");
	var popUpBackground = document.getElementById("popUpBackground");
	instargramPopUp.style.display = "none";
	popUpBackground.style.display = "none";
}
