...
<html lang="ko">
    <head>
        ...
        <script type="text/javascript" src="../../script/myPage/changePW.js"></script>
                ...
                <form action="../../php/myPage/changePassword.php" method='POST'>
                    ...
                    <table class="myDataArea">
                        <tr>
                            ...
                            <td class="rightBoxes"><input class='text' id="userPw" type='password' name='user_pw'></td>
                        </tr>
                        <tr>
                            <td class="leftTitles"><p class="leftTitle">비밀번호 확인</p></td>
                            <td class="rightBoxes"><input class='text' id="userPwAgain" type='password'></td>
                        </tr>
                    </table>   
                    <div class="lowerButtons">
                        <button type='submit' name='submit' id="SearchBox" class="lowerBt dataFix">수정 완료</button>
                    </div>                
                </form>
            </div> 
