...
while($row = mysqli_fetch_assoc($result)){
    $title = $row['INQ_TITLE'];
    $content = $row['INQ_CONTENTS'];
    $writer = $row['INQ_MEM_NICKNAME'];
    $date = $row['INQ_DATE'];
};
...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="../../css/notice/question_answer.css">
        ...
        <div id="wrap">
            ...
            <div class='contents'>
                <div class='contents_head'>
                    <h1><?=$title?></h1>
                    <button><a href="./question.php">목록</a></button>
        ...
        <script>
            ...
            $(function(){
                if(id_num == 1){
                    ...
                    $("#next").click(function(){
                        location = './question_answer.php?id="'+(id_num-1)+'"';
                    });
                }
                if(id_max == id_num){
                    $("#prev").click(function(){
